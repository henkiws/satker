    ...
    <div class="flex-1 sm:ml-64">
        ...
        <div class="p-4 sm:p-6 lg:p-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-primary">Data PPBJ</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    <h2 class="text-2xl font-bold text-primary-dark">Data PPBJ</h2>
                    <p class="text-sm text-gray-600 mt-1">Kelola data Pengelola Pengadaan Barang/Jasa</p>
                </div>
                <a href="<?php echo BASE_URL; ?>/ppbj/create" class="inline-flex items-center px-4 py-2.5 bg-primary hover:bg-primary-dark text-white font-medium rounded-lg transition-all shadow-md hover:shadow-lg">
