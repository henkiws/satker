        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold text-primary-dark">Edit Satker</h1>
                </div>
            </div>
        </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 sm:p-8">
                    <form action="<?php echo BASE_URL; ?>/satker/update/<?php echo $satker->id; ?>" method="POST">
                        <!-- Kode -->
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   id="kode" 
                                   name="kode" 
                                   value="<?php echo Helper::old('kode', $satker->kode); ?>"
                                   required
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   id="nama" 
                                   name="nama" 
                                   value="<?php echo Helper::old('nama', $satker->nama); ?>"
                                   required
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="alamat" 
                                      ...
                                      rows="4"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                                      placeholder="Masukkan alamat satker"><?php echo Helper::old('alamat', $satker->alamat); ?></textarea>
                        </div>
