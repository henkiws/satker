        ...
        <div class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center">
                    ...
                    <h1 class="text-2xl font-bold text-primary-dark">Tambah User</h1>
                </div>
            </div>
        </div>
                    ...
                    <form action="<?php echo BASE_URL; ?>/user/store" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   id="username" 
                                   name="username" 
                                   value="<?php echo Helper::old('username'); ?>"
                                   required
                        ...
                        <div class="mb-6">
                            ...
                            <select id="role" 
                                ...
                                <option value="admin" <?php echo Helper::old('role') == 'admin' ? 'selected' : ''; ?>>Admin</option>
                                <option value="satker" <?php echo Helper::old('role') == 'satker' ? 'selected' : ''; ?>>Satker</option>
                                <option value="ppbj" <?php echo Helper::old('role') == 'ppbj' ? 'selected' : ''; ?>>PPBJ</option>
                            </select>
                        </div>
